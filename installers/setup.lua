...
local function getFiles(folder)
    local url = "https://api.github.com/repos/" .. user .. "/" .. repo .. "/contents/" .. folder
    ...
    res.close()
    local files, _ = json.parse(content)
...
local function getAllFiles() 
    for _, folder in ipairs(folders) do
        local file_urls = getFiles(folder)
        for _, f in ipairs(file_urls) do
